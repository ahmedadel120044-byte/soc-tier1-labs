...
| **Splunk: Exploring SPL** | SIEM & Queries | Medium | [View Writeup](./tryhackme/Splunk: Exploring SPL) | Splunk Enterprise, SPL Queries, Log Correlation (join), GeoIP Enrichment (iplocation), Sysmon & Windows Logs, Anomaly Detection
